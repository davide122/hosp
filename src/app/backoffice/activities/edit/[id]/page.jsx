    ...
    <div className="min-h-screen bg-gray-900 text-white">
      <header className="bg-gray-800 shadow-md py-4 px-6">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold text-purple-400">Modifica Attività</h1>
      ...
      <main className="container mx-auto py-8 px-4">
        ...
        {success && (
          <div className="bg-green-500 text-white p-4 rounded-md mb-6">
            Attività aggiornata con successo! Reindirizzamento in corso...
          </div>
        )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-6 border-t border-gray-700">
              <button
                type="submit"
                disabled={saving}
                className={`w-full py-3 px-4 rounded-md font-medium text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 ${saving ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
                {saving ? 'Salvataggio in corso...' : 'Aggiorna Attività'}
              </button>
            </div>
          </form>
        </div>
